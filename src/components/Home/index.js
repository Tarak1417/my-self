...
const Home = () => (
    ...
    <div className="coveredf">
      ...
      <h1 className='homeIamDev'><span className='helloSSpan'>HELLO </span>It's me  <span className="hilatedname">Tarak</span> </h1>
      <p className='homeDeveaddexta'>I am a professional web developer</p>
